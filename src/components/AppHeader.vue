<template>
  <div class="navbar rounded-lg bg-neutral text-neutral-content">
    <div class="navbar-start">
      ...
      <a class="btn btn-ghost text-xl">Travel Destinations</a>
    </div>
      ...
      <ul class="menu menu-horizontal px-1">
        ...
        <li>
          <details>
            ...
            <ul class="p-2">
              <li>
                <a class="w-full text-nowrap text-center"
                  >Eksotikh Peloponisos</a
                >
              </li>
              <li>
                <a class="w-full text-nowrap text-center">Trip 2</a>
              </li>
            </ul>
          </details>
        </li>
        <li><a>Trips Overview</a></li>
      </ul>
    </div>
    <div class="dropdown dropdown-end navbar-end flex">
      ...
      >
        <div class="card-body">
          <span class="text-lg font-bold">No items in cart</span>
